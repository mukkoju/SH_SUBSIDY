...
//       }); 
   ...
   function loadHtml(el, index, target, d){
       ...
       if(target.hasClass('brws-team')){
           ...
           var data = '<div class="pos-lsting"><div class="pos-lsting-hdr">'+d[0]._Team_+'</div><ul>';
              ...
              data += '<li class="pos-itm"><div class="pos-itm-ttl">'+d[i]._Ttl_+'</div><span class="job-nav"><i class="icon-plus"></i></span><div class="clearfix"></div><div class="job-desc">';
              data += '<p>'+d[i]._Dsc_.dsc+'</p>';
              if(d[i]._Dsc_.rls[0] != ''){
              data += '<div class="job-section"><div class="job-section-hdng">Responsibilities</div><ul>';
              ...
              data += '<div class="job-section"><div class="job-section-hdng">Desired</div><ul>';
              for(var l = 0; l<d[i]._Dsc_.dsird.length; l++){
              data+= '<li>'+d[i]._Dsc_.dsird[l]+'</li>';
               }
              data += '</ul></div>';}
              if(d[0]._Team_Id_ == 'journalists'){
              data += '<p class="apply-note">To be considered for this role, Write a story in saddahaq.com, send that Story Url, Your CV and earliest possible start date to to <a href="mailto:careers@saddahaq.com">careers@saddahaq.com.</a></p>';
               }else
              data += '<p class="apply-note">To be considered for this role, send your application, CV and earliest possible start date to <a href="mailto:careers@saddahaq.com">careers@saddahaq.com</a>.</p>';    
              data += '</li></ul><div>';
              }
              }else{
       ...
       el.html(data);
         ...
         data += '<div id="job-roles" class="spcfctns"><div class="control-group"> <p class="dsc">Role & Responsibilities<sup class="err-msg"></sup></p> <ul class="jb-list-itms"><li><input type="text" placeholder="Role & Responsibilities" class="blk-txt input-xxlarge box" style="border: 0px;border-bottom: 1px solid #ddd;"><span class="addlst-itm"><i class="icon-plus"></i></span></li></ul> </div></div>'; 
         data += '<div id="job-reqrmnts" class="spcfctns"><div class="control-group"> <p class="dsc">Requirements<sup class="err-msg"></sup></p> <ul class="jb-list-itms"><li><input type="text" placeholder="Requirements" class="blk-txt input-xxlarge box" style="border: 0px;border-bottom: 1px solid #ddd;"><span class="addlst-itm"><i class="icon-plus"></i></span></li></ul> </div></div>';
         data += '<div id="job-disred" class="spcfctns"><div class="control-group"> <p class="dsc">Desired & Skills<sup class="err-msg"></sup></p> <ul class="jb-list-itms"><li><input type="text" placeholder="Desired & Skills" class="blk-txt input-xxlarge box" style="border: 0px;border-bottom: 1px solid #ddd;"><span class="addlst-itm"><i class="icon-plus"></i></span></li></ul> </div></div>'; 
   ...
   $('body').on('click', '.fly .pos-itm-ttl, .job-nav', function(){
      ...
      if($this.hasClass('actv')){
          $this.removeClass('actv').find('.job-nav i').removeClass('icon-minus').addClass('icon-plus');
      }else{
      $this.addClass('actv').find('.job-nav i').removeClass('icon-plus').addClass('icon-minus');
   ...
   $('body').on('click', '.fly .addlst-itm', function(){
      ...
      parent.append('<li><input type="text" placeholder="Role &amp; Responsibilities" class="blk-txt input-xxlarge box" style="border: 0px;border-bottom: 1px solid #ddd;"><span class="addlst-itm"><i class="icon-minus"></i></span></li>');
       }else{
