        ...
        <div class="container-fluid">
            ...
            <div id="stream">
                <div class="strm-sec number-counters">
                    ...
                    <div class="sec">
                        <div class="stat"><span data-to="1000">99999+</span><p style="margin-top: -24px; font-size: 1em !important;">PLEDGES</p></div>
                        <div class="stat"><span data-to="1000">99999+</span><p style="margin-top: -24px;">REQUESTS</p></div>
                ...
                <div class="strm-sec">
                    ...
                    <div class="sec">
                        <div class="stat"><span>&nbsp</span></div>
                    </div>
                    <div class="sec">
                        <div class="stat"><span>&nbsp</span></div>
                    </div>
            ...
            <div id="gvup-frm">
                <div id="pldge" class="stp-frm">
                    ...
                    <div class="grid2 grid">
                        <label>
                            Name<br>
                            <input type="text" placeholder="Name" id="pldgr-name">
                    ...
                    <div class="grid2 grid">
                        <label>
                            Email<br>
                            <input type="text" placeholder="Email" id="pldgr-email">
                        </label>
                    </div>
